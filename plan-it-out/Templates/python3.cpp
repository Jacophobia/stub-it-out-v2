...
auto python3_template::get_class_string(
...
auto python3_template::get_variable_strings(variable_iter begin, const variable_iter& end) -> std::string
{
...
auto python3_template::get_parameter_strings(variable_iter begin, const variable_iter& end) -> std::string
{
...
auto python3_template::get_method_strings(method_iter begin, const method_iter& end) -> std::string
{
...
auto python3_template::to_file(function_prototype *p_function) -> file
{
    ...
    return { "functions.py", function_string };
}
